...
<script setup>
  ...
  // Same actions-column collapse as views/peer/index.vue - Edit/Delete
  // moved into this dropdown so the column doesn't need a 500px fixed
  // width.
  const handleRowCommand = (command, row) => {
    if (command === 'edit') toEdit(row)
